...
from dateutil.relativedelta import relativedelta # as importing libs is monotone, it wont repeat in utils
from .. import utils


class MrEstateSpiderSpider(scrapy.Spider):
    name = 'mr_estate_spider'
    ...
    def parse(self, response):
        ...
        for ad in ads:
            ...
            house = items.HousePriceCrawlerItem(link = link)
            if link:
                print(link)
